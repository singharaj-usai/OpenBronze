...
--]]
--== Configuration;
local defaultDatabase = "https://yourfirebaselink-default-rtdb.firebaseio.com/"; -- Set your database link
local authenticationToken = "yourauthtokenhere"; -- Authentication Token
